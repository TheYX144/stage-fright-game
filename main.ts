...
function Title_Screen () {
    scene.setBackgroundImage(img`
        ...
        `)
    Title_Sprite = textsprite.create("Stage Fright", 12, 1)
    Title_Sprite.scale += 0.5
    Title_Sprite.setPosition(80, 60)
    Button_Indicator = sprites.create(img`
        ..........666666666666..........
        ........6667777777777666........
    ...
    Button_Indicator.scale += -0.35
    Button_Indicator.y += 35
    title = 1
}
let Button_Indicator: Sprite = null
